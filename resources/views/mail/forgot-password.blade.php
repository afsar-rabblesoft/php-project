            ...
            <tr>
                <td>
                    <table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-1"
                        role="presentation"
                        style="padding-top: 30px;padding-bottom: 5px;mso-table-lspace: 0; mso-table-rspace: 0; background-color: #42484f;"
                        width="100%">
                        <tbody>
                            <tr>
                                <td>
                    ...
                    <table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-3"
                        role="presentation"
                        style="mso-table-lspace: 0; mso-table-rspace: 0; background-color: #42484f;" width="100%">
                        <tbody>
                            <tr>
                                <td>
                                    <table align="center" border="0" cellpadding="0" cellspacing="0"
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td
                                                                ...
                                                                <div align="center" style="line-height:10px"><img
                                                                        alt="reset-password"
                                                                        src="{{ asset('img/avatars/pass-animate.gif') }}"
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div style="font-family: Tahoma, Verdana, sans-serif">
                                                                    <div
                                                                        style="font-size: 12px; font-family: Tahoma, Verdana, Segoe, sans-serif; color: #393d47; line-height: 1.5;">
                                                                        <p
                                                                            style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 21px;">
                                                                            <span style="font-size:14px;">if You've lost Your Password or wish to reset it,
                                                                                <br>
                                                            ...
                                                            <td>
                                                                <div align="center">
                                                                    <a href="{{ $user_data['link'] ?? '' }}"
                                                                        style="text-decoration:none;display:inline-block;color:#393d47;background-color:#ec9659;border-radius:20px;width:auto;border-top:1px solid #FFC727;border-right:1px solid #FFC727;border-bottom:1px solid #FFC727;border-left:1px solid #FFC727;padding-top:10px;padding-bottom:10px;font-family:Tahoma, Verdana, Segoe, sans-serif;text-align:center;mso-border-alt:none;word-break:keep-all;"
                                                                        target="_blank"><span
                                                                            style="padding-left:50px;padding-right:50px;font-size:18px;display:inline-block;letter-spacing:normal;"><span
                                                                                style="font-size: 16px; line-height: 2; word-break: break-word; mso-line-height-alt: 32px;"><span
                                                                                    ...
                                                                                    style="font-size: 18px; line-height: 36px;"><strong>Reset Your
                                                    ...
                                                    <table border="0" cellpadding="10" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div style="font-family: Tahoma, Verdana, sans-serif">
                                                                    <div
                                                                        style="font-size: 12px; font-family: Tahoma, Verdana, Segoe, sans-serif; text-align: center; color: #393d47; line-height: 1.5;">
                                                                        <p
                    ...
                    <table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-5"
                        role="presentation"
                        style="mso-table-lspace: 0; mso-table-rspace: 0; background-color: #42484f;padding-bottom: 30px;padding-top: 30px;"
                        width="100%">
                        <tbody>
                            <tr>
                                <td>
